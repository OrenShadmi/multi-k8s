...
kubectl set image deployments/server-deployment server=orenshadmi/multi-server:$SHA
kubectl set image deployments/client-deployment client=orenshadmi/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=orenshadmi/multi-worker:$SHA